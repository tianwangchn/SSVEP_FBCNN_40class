...
if __name__ == "__main__":
    ...
    for i in range(len(all_trailers)):
        ...
        train_datas,train_labels = data_batch_FFT_one_tester_complex_UD(all_trailers[i],time_length=1)
        ...
        for train_index, test_index in kf.split(train_datas):
            ...
            EEG_model = cnn_model((9,502,1),decay = 0.0001) #complex: 11,502,1 or abs: 11,251,1
